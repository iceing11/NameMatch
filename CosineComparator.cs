...
public class CosineComparator : IComparator
{
    ...
    {
        var ngrams1 = GetNgramsUpToSize(word1, 2);
        var ngrams2 = GetNgramsUpToSize(word2, 2);
    ...
    {
        var result = new List<string>(word.Length * size);
    ...
    {
        List<string> ngrams = new List<string>(word.Length);
